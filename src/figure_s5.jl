...
function si_plot()
    ...
    img_graph = rotr90(load(joinpath(@__DIR__, "screenshot_aggregation.png")))
    ...
    img_graph2 = rotr90(load(joinpath(@__DIR__, "screenshot_ligation_points.png")))
    ...
    img_controls = rotr90(load(joinpath(@__DIR__, "controls_annot.png")))
    ...
    img_menu = rotr90(load(joinpath(@__DIR__, "screenshot_plots_menu_annot.png")))
    ...
    save(joinpath(@__DIR__, "figure_si_S5.svg"), fig)
